...
function LgpsmLogo() {
  return (
    <div className={styles.logo} aria-label="LGPSM" role="img">
      <svg className={styles.logoMark} viewBox="0 0 54 40" fill="none" aria-hidden="true">
      ...
      <svg className={styles.logotype} viewBox="0 0 164.311 100" fill="none" aria-hidden="true">
  ...
  return (
    <main className={styles.page}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.message}>The path may be broken, but the journey isn&apos;t. Let&apos;s get you back.</p>
      </div>
    </main>
  );
}
